...
public class CustomMy extends ScrollView {
    ...
    public CustomMy(Context context) {
        super(context);
    }

    public CustomMy(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomMy(Context context, AttributeSet attrs, int defStyleAttr) {
