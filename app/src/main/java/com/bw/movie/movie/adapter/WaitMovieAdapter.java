 ...
 */
public class WaitMovieAdapter extends RecyclerView.Adapter<WaitMovieAdapter.ViewHolder> {
    private Context mContext;
    private List<WaitMovieBean.ResultBean> mList;

    public WaitMovieAdapter(Context context) {
        mContext = context;
        mList = new ArrayList<>();
    }

    public void setData(List<WaitMovieBean.ResultBean> list) {
        mList = list;
