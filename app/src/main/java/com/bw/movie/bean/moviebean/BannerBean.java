...
public class BannerBean {
    ...
    private List<LoadingMovieBean.ResultBean> result;
    ...
    public List<LoadingMovieBean.ResultBean> getResult() {
        return result;
    }

    public void setResult(List<LoadingMovieBean.ResultBean> result) {
        this.result = result;
    }
